...
power_supply = power_supply_san_diego;
power_demand = power_demand_commercial_building;
...
% Checking if power_supply and power_demand data have the same size
if size(power_supply,1) ~= size(power_demand,1)
    ...
    % scaling expected annual generation to equal expected annual consumption 
